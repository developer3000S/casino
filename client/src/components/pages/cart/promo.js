...
function Promo(props){
    ...
    return <div id="cart_promo" className="cart_box shadow_concav">
        ...
        <form className="form-inline">
            <input className="input_light shadow_concav" type="text" placeholder={translate({lang, info: "promo_code"})} onChange={(e)=>{updateInputValue(e)}}/>
            <Button 
                type="button"  
                        ...
                        return <p className="alert alert-success">
                            {(() => {
                                switch (lang) {
                                    ...
                                    case "RU":
                                        return <span>Скидка {coupon.discount}%</span>
                                    case "ENG":
                                    default:
